...
def main():
    ...
    print("  📱 Attendee 3D App:     http://localhost:8000")
    print("  📊 Operator Dashboard:  http://localhost:8000/dashboard")
    print("  🔧 Debug Console:       http://localhost:8000/debug")
    print("  📡 Backend API Docs:    http://localhost:8000/docs")
    print("  🌐 Next.js Dev Server:  http://localhost:3000 (Optional)")
    print("\n" + "="*60)
